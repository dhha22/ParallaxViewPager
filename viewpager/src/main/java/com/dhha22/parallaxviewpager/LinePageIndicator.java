package com.dhha22.parallaxviewpager;
...
/**
 * Created by CAMSCON on 2016. 3. 15..
 */
public class LinePageIndicator extends View implements PageIndicator {
    ...
    public LinePageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        final int defaultTextColor = res.getColor(R.color.default_text_color);

        final float defaultGapWidth = res.getDimension(R.dimen.default_line_indicator_gap_width);
        final float defaultStrokeWidth = res.getDimension(R.dimen.default_line_indicator_stroke_width);
        final boolean defaultCentered = res.getBoolean(R.bool.default_line_indicator_centered);
        final float defaultTextSize = res.getDimension(R.dimen.default_text_size);
        ...
        mLineWidth = (float) ((displayWidth * 0.8) / pageCount);
        mTextWidth = (float) (displayWidth - (displayWidth * 0.2) / 2);
        mGapWidth = a.getDimension(R.styleable.LinePageIndicator_gapWidth, defaultGapWidth);
        setStrokeWidth(a.getDimension(R.styleable.LinePageIndicator_strokeWidth, defaultStrokeWidth));
        mPaintUnselected.setColor(a.getColor(R.styleable.LinePageIndicator_unselectedColor, defaultUnselectedColor));
        mPaintSelected.setColor(a.getColor(R.styleable.LinePageIndicator_selectedColor, defaultSelectedColor));
        mPaintText.setColor(a.getColor(R.styleable.TextPageCount_selectedColor, defaultTextColor));
        mPaintText.setTextSize(a.getDimension(R.styleable.TextPageCount_textSize, defaultTextSize));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mLineWidth = (float) ((displayWidth * 0.8) / count);
        ...
        final String mText = (mCurrentPage + 1) + "/" + count;

        //Draw Page Count Text
        canvas.drawText(mText, mTextWidth, verticalOffset * 1.2f, mPaintText);
    }
